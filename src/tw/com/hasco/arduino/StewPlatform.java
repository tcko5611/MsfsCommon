...
public class StewPlatform implements Observer, Runnable {
    ...
    /*
     * ******************************************************************************
     * P1 = translation in X direction (sway) S* = Sin(theta_*) P2 = translation
     * in Y direction (surge) C* = Cos(theta_*) P3 = translation in Z direction
     * (heave) e.g. C1 = Cos(theta_1)
     *
     * General Matrix for Yaw-Pitch-Roll-Sway-Surge-Heave Transformation | C2C3
     * S1S2C3 - C1S3 C1S2C3 + S1S3 P1 | | X | | q[0] | | C2S3 S1S2S3 + C1C3
     * C1S2S3 - S1C3 P2 | x | Y | = | q[1] | | -S2 S1C2 C1C2 P3 | | Z | | q[2] |
     * | 0 0 0 1 | | 1 | | 1 | where: X = L1 theta_1 = 0 Y = 0 theta_2 = theta_a
     * Z = 0 theta_3 = theta_s
     * ******************************************************************************
     */
 /*
