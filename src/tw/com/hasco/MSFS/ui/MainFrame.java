...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        stopClientButton = new javax.swing.JButton();
        ...
        clientButton.setFont(new java.awt.Font("新細明體", 0, 14)); // NOI18N
        clientButton.setText("傳送資料");
        ...
        serverButton.setFont(new java.awt.Font("新細明體", 0, 14)); // NOI18N
        serverButton.setText("接收資料");
        ...
        stopClientButton.setFont(new java.awt.Font("新細明體", 0, 14)); // NOI18N
        stopClientButton.setText("停止傳送資料");
        stopClientButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                stopClientButtonActionPerformed(evt);
            }
        });

        stopReceiveButton.setFont(new java.awt.Font("新細明體", 0, 14)); // NOI18N
        stopReceiveButton.setText("停止接收資料");
        ...
        networkMenu.setFont(new java.awt.Font("微軟正黑體", 0, 14)); // NOI18N

        receiveMenuItem.setFont(new java.awt.Font("微軟正黑體", 0, 14)); // NOI18N
        receiveMenuItem.setText("接收資料");
        receiveMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                receiveMenuItemActionPerformed(evt);
            }
        });
        networkMenu.add(receiveMenuItem);

        sendMenuItem.setFont(new java.awt.Font("微軟正黑體", 0, 14)); // NOI18N
        sendMenuItem.setText("傳送資料");
    ...
    private void clientButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clientButtonActionPerformed
        // TODO add your handling code here:
        if (udpClient != null && dataGetter != null) {
            dataGetter.removeObserver(udpClient);
        }
        try {
            udpClient = new MsfsUdpClient(clientFrame.getIp(), clientFrame.getPort());
            if (dataGetter != null) dataGetter.addObserver(udpClient);
        } catch (UnknownHostException | SocketException ex) {
            Logger.getLogger(MainFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_clientButtonActionPerformed

    private void stopClientButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stopClientButtonActionPerformed
        // TODO add your handling code here:
        if (udpClient != null && dataGetter != null) {
            dataGetter.removeObserver(udpClient);
        }
        udpClient = null;
    }//GEN-LAST:event_stopClientButtonActionPerformed

    private void serverButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_serverButtonActionPerformed
        try {
            // TODO add your handling code here:
            if (udpServer != null) udpServer.stop(true);
            udpServer = new MsfsUdpServer(serverFrame.getPort());
            executor.execute(udpServer);
            if (dataGetter != null) {
                udpServer.addObserver(plotTraceFrame);
            }
    ...
    public static void main(String args[]) throws IOException {
        ...
        MainFrame dataFrame = new MainFrame();
    ...
    private javax.swing.JButton stopClientButton;
